...
public class LoginVolunteerActivity extends AppCompatActivity implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case REGIST_WHAT_SUCCESS:
                    Toast.makeText(LoginVolunteerActivity.this,"注册成功",Toast.LENGTH_LONG).show();
                    break;
                case REGIST_WHAT_FAILE:
                    String dis= (String) msg.obj;
                    Toast.makeText(LoginVolunteerActivity.this,dis,Toast.LENGTH_LONG).show();
                    break;
                case LOGIN_WHAT_SUCCESS:
                    Toast.makeText(LoginVolunteerActivity.this,"登录成功",Toast.LENGTH_SHORT).show();
                    Intent intent=new Intent(LoginVolunteerActivity.this, MainVolunteerActivity.class);
        ...
        if (!TextUtils.isEmpty(username) && !TextUtils.isEmpty(password)){
            new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    try{
                        JSONObject json=new JSONObject(getConnectionContent(URLSTRING2));
    ...
    private void login() {
        ...
        EMClient.getInstance().login(userName,password,new EMCallBack() {
            ...
            public void onSuccess() {
                ...
                try{
                    JSONObject json=new JSONObject(getConnectionContent(URLSTRING4));
                    String dataMap= json.getString("dataMap");
                    JSONObject dM=new JSONObject(dataMap);
                    isSuccess=dataMap;
            ...
            public void onError(int code, final String message) {
                ...
                runOnUiThread(new Runnable() {
                    @Override
                    public void run() {
                        Toast.makeText(LoginVolunteerActivity.this,"登录聊天服务器失败:"+message,Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
