...
public class Language {
    ...
    public String name;
    public int flag;
    private static ArrayList<Language> countries = null;

    public Language(int code, String name, String locale, int flag) {
        this.code = code;
        this.name = name;
        this.flag = flag;
    }
    ...
    public static ArrayList<Language> getAll(@NonNull Context ctx, @Nullable ExceptionCallback callback) {
        ...
        try {
            ...
            for (int i = 0; i < ja.length(); i++) {
                ...
                countries.add(new Language(jo.getInt("code"), jo.getString(inChina? "zh" : "en"), locale, flag));
            }
